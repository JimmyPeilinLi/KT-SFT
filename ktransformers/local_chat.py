...
if __name__ == "__main__":
    ...
    if IS_DEBUG == False:
        ...
        local_chat(
            ...
            save_adapter_path="/mnt/data/lpl/test_adapter/Pip_KT_singleGPU_deepseekV2_Neko",
            use_adapter=False,
            use_adapter_path="/mnt/data/lpl/test_adapter/Kllama_KT_newest_deepseekV2_WEST",
            is_test_data=False,
