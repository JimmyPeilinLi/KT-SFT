...
class KTransformersLinearLora(LoraLayer, KTransformersLinear):  # 保持原始继承顺序
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super().__init__(self, base_layer, **kwargs)
        super(LoraLayer, self).__init__(key=base_layer.key, gguf_loader=base_layer.gguf_loader, config=base_layer.config, orig_module=base_layer.orig_module,
                        generate_op="KLinearTorch")
        # # 先初始化KTransformersLinear以创建orig_module
        # KTransformersLinear.__init__(
        #     self,
        #     key=base_layer.key,
        #     gguf_loader=base_layer.gguf_loader,
        #     config=base_layer.config,
        #     orig_module=base_layer.orig_module,  # 关键点：显式传递orig_module
        ...
        # LoraLayer.__init__(
        #     self, 
        #     base_layer=self.orig_module,  # 使用已初始化的orig_module
        #     **kwargs
        # )
        self._active_adapter = adapter_name
